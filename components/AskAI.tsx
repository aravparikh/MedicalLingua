...
const L = {
  es: {
    ...
    subtitle: 'Haga preguntas sobre su visita. El asistente solo usa información del doctor.',
    ...
    chip: '🩺 Asistente Médico',
  },
  en: {
    title: 'Ask MedLingua',
    subtitle: 'Ask questions about your visit. The assistant only uses information from your doctor.',
...
const s = StyleSheet.create({
  ...
  suggestionsLabel: {
    fontSize: 14, fontWeight: '900', color: C.inkMute,
  ...
  suggestionText: { flex: 1, fontSize: 16, color: C.ink2, fontWeight: '700' },
  ...
  userText: { fontSize: 16, color: '#fff', lineHeight: 22, fontWeight: '600' },
  assistantText: { fontSize: 16, color: C.ink, lineHeight: 22, fontWeight: '600' },
  cursor: { color: C.primary, fontWeight: '900', opacity: 0.85 },
  errorText: { fontSize: 16, color: C.alert, fontWeight: '700' },
  thinkingRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  thinkingText: { fontSize: 16, color: C.inkSoft, fontWeight: '700' },
