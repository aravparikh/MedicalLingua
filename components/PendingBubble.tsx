...
const s = StyleSheet.create({
  ...
  bubbleProvider: {
    backgroundColor: '#E6EDFF66',
    borderColor: '#2563EB22',
    borderBottomRightRadius: 6,
  },
  bubblePatient: {
    backgroundColor: '#D5F3EF66',
    borderColor: '#0D948822',
  ...
  label: { fontSize: 13, fontWeight: '800', color: '#0D9488', letterSpacing: 0.2 },
  labelBlue: { color: '#2563EB' },
  skeletonStack: { gap: 8 },
  skelLine: {
