...
const s = StyleSheet.create({
  ...
  phoneModeTitle: { fontSize: 20, color: C.ink, fontWeight: '900', marginBottom: 2 },
  phoneModeText: { fontSize: 18, lineHeight: 24, color: C.ink2, fontWeight: '700' },
  scroll: { flex: 1 },
  ...
  statLabel: { fontSize: 16, fontWeight: '800', color: C.ink2, textAlign: 'center', letterSpacing: 0.1 },
});
